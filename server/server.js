    ...
    request(languageOptions, function (error, response, body) {
        ...
        request(luisOptions, function (error, response, body) {
            ...
            if (errorCode.includes('REG99')) {
                ...
                responseBody.solution = "\n Restart your device.\n Turn off Wi-Fi to make sure youre using the T-Mobile network.\n Check whether the number youre messaging is on the device Block or Spam List. If it is, you wont be able to text to that number.\n Update the time and date on your device and enable auto-update.\n Uninstall any downloaded messaging apps.\n (Android only): Clear the messaging app cache and make sure the SMSC setting is +120630004.\n App cache: Choose Email & Messaging > Manage messages.\n SMSC setting: Choose Apps & Accessories > Manage apps.";
            }
